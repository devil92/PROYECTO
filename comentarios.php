  ...
  <tr>
    ...
    <?php
          ...
          //CREATING THE CONNECTION
			$connection = new mysqli($db_host, $db_user, $db_password, $db_name);          //TESTING IF THE CONNECTION WAS RIGHT
...
<table border="1" id="tabla">
  <tr>
	...
	<p>
	</a><input name="anadirusu" a class='ajax' href="anadircomen.php" title="Añadir comentario" type="submit" id="boton" value="Añadir" style="margin-left:300px" class="boton"/ ></p>
